...
import { Search, MapPin, DollarSign, Users, Filter, Heart, MessageCircle, Phone } from "lucide-react"

export default function RoommateFeed({ posts, onPostSelect, onNavigate, currentUser }) {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
        <div>
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Tìm bạn cùng phòng</h1>
          <p className="text-gray-600">{filteredPosts.length} tin đăng</p>
        </div>
      ...
      {filteredPosts.length === 0 ? (
        <div className="text-center py-12">
          ...
          <h3 className="text-xl font-semibold text-gray-900 mb-2">Không tìm thấy tin đăng</h3>
